...
# (numero de arboles, numero de clases/ramificaciones por arbol)
trees = RandomForestRegressor(n_estimators = 300, max_depth= 8)
...
plt.plot(X_grid,trees.predict(X_grid), color = 'red')
plt.show()

# Precisión del Modelo según R^2
print(trees.score(X_train,Y_train))